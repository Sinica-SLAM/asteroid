...
def get_statistics(args, dataset):
    ...
    print('scaler mean',scaler.mean_.shape,'std',std)
...
def main(conf, args):
    ...
    print('train_tracks: ',len(train_dataset.tracks))
    dataloader_kwargs = (
    ...
    print('scaler_mean',scaler_mean.shape,'scaler_std',scaler_std.shape)
